...
const { data: pageResponse } = await useAsyncData('confidentiality', () =>
  find('confidentiality', {
...
<template>
  <div v-if="pageData" class="container mx-auto px-4 py-20 max-w-4xl">
    ...
    <header class="mb-16 text-center">
      <h1 class="text-4xl md:text-5xl font-bold mb-6 text-gray-900">Politique de confidentialité</h1>
